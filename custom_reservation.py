...
def eg_rule_action1(memory_type: str, memories_info: List["MemoryInfo"], args: Dict[str, Any]) -> Tuple[EntanglementGenerationA, List[None], List[None], List[None]]:
    ...
    index = args["index"]
    if memory_type == "Yb":
        protocol = EntanglementGenerationTimeBin(None, "EGTB." + memory.name, mid, path[index - 1], memory)
